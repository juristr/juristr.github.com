...
export declare abstract class DomAdapter {
    ...
    abstract isPageRule(rule: any): boolean;
    abstract isStyleRule(rule: any): boolean;
    abstract isMediaRule(rule: any): boolean;
    abstract isKeyframesRule(rule: any): boolean;
