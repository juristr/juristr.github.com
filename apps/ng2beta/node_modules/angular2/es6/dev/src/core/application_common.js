...
import { platformCommon, applicationCommonProviders } from './application_ref';
/**
 * A default set of providers which apply only to an Angular application running on
 * the UI thread.
 */
export function applicationDomProviders() {
    if (isBlank(DOM)) {
 ...
 */
export function commonBootstrap(appComponentType, appProviders = null) {
    var p = platform();
