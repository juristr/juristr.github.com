...
<html lang="en-us"><head>
	...
	<title>Detect when node_modules are out of sync | juri.dev</title>
	
	<meta name="description" content="Remember those moments when you have those weird issues, and all that was needed was a clean node_modules install">
	...
	<meta name="twitter:title" content="Detect when node_modules are out of sync" />
	
	<meta name="twitter:description" content="Remember those moments when you have those weird issues, and all that was needed was a clean node_modules install" />
	

	
	<meta name="twitter:image:src" content="https://juristr.com/blog/assets/imgs/node-modules-detection.png" />
	

	
	<meta property="og:type" content="article" />
	<meta property="og:title" content="Detect when node_modules are out of sync" />
	
	<meta property="og:description" content="Remember those moments when you have those weird issues, and all that was needed was a clean node_modules install" />
	
	
	<meta property="og:image" content="https://juristr.com/blog/assets/imgs/node-modules-detection.png" />
	
	<meta property="og:url" content="https://juristr.com/blog/2020/09/detect-node_modules-out-of-sync" />
...
<div class="container page-container">
    ...
    <ul>
        <li>
            <a target="_blank" href="https://twitter.com/home?status=Check out this post by @juristr https%3a%2f%2fjuristr.com%2fblog%2f2020%2f09%2fdetect-node_modules-out-of-sync%2f">
        ...
        <li>
            <a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=https%3a%2f%2fjuristr.com%2fblog%2f2020%2f09%2fdetect-node_modules-out-of-sync%2f">
                <svg class="svgIcon-use" width="29" height="29" viewbox="0 0 29 29">
        ...
        <div class="col-md-9 col-md-offset-2 col-xs-12">
            <div class="mainheading">
                ...
                <h1 class="posttitle">Detect when node_modules are out of sync</h1>
                
                <h2 class="article-subtitle">Remember those moments when you have those weird issues, and all that was needed was a clean node_modules install</h2>
...
<p>Actually, if you&rsquo;re using Webstorm you might be on the safe side becaus it&rsquo;ll show you a nice little notification whenever it detects that <code>node_modules</code> are out of date. But not everyone uses Webstorm. (Personally big VSCode fan but currently kinda jumping back and forth between the two).</p>

<p>So, Emma just tweeted about exactly this problem, which reminded me of a script.</p>

<blockquote class="twitter-tweet"><p lang="en" dir="ltr">When you sit around for 20 minutes trying to figure out why your local environment isn&#39;t working... and then you realize you forgot to npm install after rebasing on master.<br><br>Is it the weekend yet?</p>&mdash; Emma Bostian (@EmmaBostian) <a href="https://twitter.com/EmmaBostian/status/1298916262559576065?ref_src=twsrc%5Etfw">August 27, 2020</a></blockquote>
<script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
...
<pre><code>$ git diff-tree -r --name-only --no-commit-id &lt;previous-head&gt; &lt;current-head&gt;
</code></pre>
...
<pre><code>$ git diff-tree -r --name-only --no-commit-id main HEAD
.gitlab-ci.yml
angular.json
...
<p>So let&rsquo;s implement it as a Node.js script.</p>
...
<div class="highlight"><pre class="chroma"><code class="language-javascript" data-lang="javascript"><span class="ch">#!/usr/bin/env node
</span><span class="ch"></span><span class="k">const</span> <span class="nx">shell</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">&#39;shelljs&#39;</span><span class="p">);</span>

<span class="c1">// we&#39;ll get these via the command line args
</span><span class="c1"></span><span class="k">const</span> <span class="p">[</span>
  <span class="nx">NODE_PATH</span><span class="p">,</span>
  <span class="nx">SCRIPT_PATH</span><span class="p">,</span>
  <span class="nx">PREVIOUS_HEAD</span><span class="p">,</span>
  <span class="nx">CURRENT_HEAD</span><span class="p">,</span>
  <span class="nx">ISBRANCH</span><span class="p">,</span>
<span class="p">]</span> <span class="o">=</span> <span class="nx">process</span><span class="p">.</span><span class="nx">argv</span><span class="p">;</span>

<span class="c1">// get a list of change files as a string
</span><span class="c1"></span><span class="kd">let</span> <span class="nx">changedFiles</span> <span class="o">=</span> <span class="nx">shell</span><span class="p">.</span><span class="nx">exec</span><span class="p">(</span>
  <span class="s1">&#39;git diff-tree -r --name-only --no-commit-id &#39;</span> <span class="o">+</span>
    <span class="nx">PREVIOUS_HEAD</span> <span class="o">+</span>
    <span class="s1">&#39; &#39;</span> <span class="o">+</span>
    <span class="nx">CURRENT_HEAD</span>
<span class="p">);</span>
</code></pre></div>
...
<h3 id="check-for-the-presence-of-package-json">Check for the presence of package.json</h3>
...
<span class="k">if</span> <span class="p">(</span><span class="nx">changedFiles</span><span class="p">.</span><span class="nx">includes</span><span class="p">(</span><span class="s1">&#39;package.json&#39;</span><span class="p">))</span> <span class="p">{</span>
   <span class="c1">// print to the user that he/she should exec an npm install
</span><span class="c1"></span>   <span class="c1">// (or even just do the npm install automatically)
...
<p>Here&rsquo;s the entire script:</p>
<div class="highlight"><pre class="chroma"><code class="language-javascript" data-lang="javascript"><span class="c1">// tools/node-modules-check.js
</span><span class="c1"></span>
<span class="ch">#!/usr/bin/env node
</span><span class="ch"></span><span class="k">const</span> <span class="nx">shell</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">&#39;shelljs&#39;</span><span class="p">);</span>
<span class="k">const</span> <span class="nx">colors</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">&#39;colors&#39;</span><span class="p">);</span>
...
<span class="kd">let</span> <span class="nx">changedFiles</span> <span class="o">=</span> <span class="nx">shell</span><span class="p">.</span><span class="nx">exec</span><span class="p">(</span>
  <span class="s1">&#39;git diff-tree -r --name-only --no-commit-id &#39;</span> <span class="o">+</span>
    <span class="nx">PREVIOUS_HEAD</span> <span class="o">+</span>
    <span class="s1">&#39; &#39;</span> <span class="o">+</span>
    <span class="nx">CURRENT_HEAD</span>
...
<span class="k">if</span> <span class="p">(</span><span class="nx">changedFiles</span><span class="p">.</span><span class="nx">includes</span><span class="p">(</span><span class="s1">&#39;package.json&#39;</span><span class="p">))</span> <span class="p">{</span>
  <span class="kd">let</span> <span class="nx">msg</span> <span class="o">=</span> <span class="s1">&#39;package.json changed: &#39;</span><span class="p">;</span>

  <span class="c1">// personalize it based on whether the user uses
</span><span class="c1"></span>  <span class="c1">// yarn or npm
</span><span class="c1"></span>  <span class="k">if</span> <span class="p">(</span><span class="nx">fs</span><span class="p">.</span><span class="nx">existsSync</span><span class="p">(</span><span class="s1">&#39;yarn.lock&#39;</span><span class="p">))</span> <span class="p">{</span>
    <span class="nx">msg</span> <span class="o">+=</span> <span class="s1">&#39;Please run &#34;yarn install&#34;&#39;</span><span class="p">;</span>
  <span class="p">}</span> <span class="k">else</span> <span class="p">{</span>
    <span class="nx">msg</span> <span class="o">+=</span> <span class="s1">&#39;Please run &#34;npm install&#34;&#39;</span><span class="p">;</span>
  <span class="p">}</span>

  <span class="c1">// some message coloring &amp; design ;)
</span><span class="c1"></span>  <span class="kd">let</span> <span class="nx">width</span> <span class="o">=</span> <span class="mi">80</span><span class="p">;</span>
  <span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span>
    <span class="nx">colors</span><span class="p">.</span><span class="nx">bold</span><span class="p">.</span><span class="nx">inverse</span><span class="p">.</span><span class="nx">yellow</span><span class="p">(</span>
      <span class="p">[</span>
        <span class="s1">&#39;=&#39;</span><span class="p">.</span><span class="nx">repeat</span><span class="p">(</span><span class="nx">width</span><span class="p">),</span>
        <span class="s1">&#39; &#39;</span><span class="p">.</span><span class="nx">repeat</span><span class="p">(</span><span class="nx">width</span><span class="p">),</span>
        <span class="nx">msg</span><span class="p">.</span><span class="nx">padStart</span><span class="p">(</span><span class="nx">msg</span><span class="p">.</span><span class="nx">length</span> <span class="o">+</span> <span class="p">(</span><span class="nx">width</span> <span class="o">-</span> <span class="nx">msg</span><span class="p">.</span><span class="nx">length</span><span class="p">)</span> <span class="err">/ 2).padEnd(width, &#39; &#39;),</span>
        <span class="s1">&#39; &#39;</span><span class="p">.</span><span class="nx">repeat</span><span class="p">(</span><span class="nx">width</span><span class="p">),</span>
        <span class="s1">&#39;=&#39;</span><span class="p">.</span><span class="nx">repeat</span><span class="p">(</span><span class="nx">width</span><span class="p">),</span>
...
<div class="highlight"><pre class="chroma"><code class="language-json" data-lang="json"><span class="err">//</span> <span class="err">package.json</span>
<span class="p">{</span>
  <span class="nt">&#34;husky&#34;</span><span class="p">:</span> <span class="p">{</span>
    <span class="nt">&#34;hooks&#34;</span><span class="p">:</span> <span class="p">{</span>
      <span class="nt">&#34;pre-commit&#34;</span><span class="p">:</span> <span class="s2">&#34;npm test&#34;</span><span class="p">,</span>
      <span class="nt">&#34;pre-push&#34;</span><span class="p">:</span> <span class="s2">&#34;npm test&#34;</span><span class="p">,</span>
...
<div class="highlight"><pre class="chroma"><code class="language-yml" data-lang="yml">hooks<span class="p">:</span><span class="w">
</span><span class="w">  </span><span class="s2">&#34;post-checkout&#34;</span><span class="p">:</span><span class="w"> </span><span class="s2">&#34;cross-env-shell node tools/node-modules-check.js $HUSKY_GIT_PARAMS&#34;</span></code></pre></div>
<p>I&rsquo;m using the <code>post-checkout</code> hook, which means it runs every time you checkout something, whether it is a new branch, a new commit etc. Which is exactly what we want, right?</p>

<h2 id="conclusion">Conclusion</h2>

<p>See the script in action on this <a href="https://github.com/juristr/detect-npm-install">GitHub repo</a>. Clone the repo and switch between it&rsquo;s <code>master</code> and <code>feature/cowsay</code> branch.</p>
...
<div class="card">
    ...
    <div class="card-block">
        <h2 class="card-title">
            <a href="/blog/2020/07/partial-commits-webstorm">Partial Commits in WebStorm</a>
        </h2>
        <h4 class="card-text">
            How to enable partial commits with WebStorm
                ...
                <div class="row">
                    <div class="col-10">
                            ...
                            <span class="author-meta">
                                ...
                                <span class="post-date">Jul 14, 2020</span><span class="dot"></span><span
...
<div class="card">
    ...
    <div class="card-block">
        <h2 class="card-title">
            <a href="/blog/2020/05/vscode-debug-jest">Debug Jest with VSCode</a>
        </h2>
        <h4 class="card-text">
            Learn how to debug your Jest tests with VSCode using Nx and the Angular CLI
            ...
            <div class="wrapfooter">
                <div class="row">
                    <div class="col-10">
                            ...
                            <span class="author-meta">
                                <span class="post-name"><a href="/about/">Juri Strumpflohner</a></span><br />
                                <span class="post-date">May 14, 2020</span><span class="dot"></span><span
                                    class="post-read">2 min read</span>
                            </span>
...
<div class="card">
    ...
    <div class="card-block">
        <h2 class="card-title">
            <a href="/blog/2019/12/git-rebase-vs-merge">Git Rebase vs Merge</a>
        </h2>
        <h4 class="card-text">
            ...
            <div class="wrapfooter">
                <div class="row">
                    <div class="col-10">
                            ...
                            <span class="author-meta">
                                <span class="post-name"><a href="/about/">Juri Strumpflohner</a></span><br />
                                <span class="post-date">Dec 18, 2019</span><span class="dot"></span><span
                    ...
                    <div class="col-2">
                        ...
                        <span class="post-category-icon">
                                ...
                                <img src="/assets/images/categories/git.svg" />
